...
public record OrnitheNestsVersionMeta(String gameVersion, String separator, int build, String maven, String version,
	...
	public String makeMavenURL() {
		return RemoteHelper.urlencodedURL(String.format("https://maven.ornithemc.net/releases/net/ornithemc/nests/%s%s%s/nests-%s%s%s.jar", gameVersion(), separator(), build(), gameVersion(), separator(), build()));
	}
}
